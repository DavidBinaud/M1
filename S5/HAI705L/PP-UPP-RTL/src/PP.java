...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr cte = new UPPCte(0);
        UPPExpr ne = e.toUPP(locals);
        return new UPPSub(cte, ne);
    }//toUPP
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr nsize = index.toUPP(locals);
        UPPExpr sizeBytes = new UPPMul(new UPPCte(4),nsize);

        UPPExpr narray = arr.toUPP(locals);
        UPPExpr naddr = new UPPAdd(narray, sizeBytes);
        return new UPPLoad(naddr);
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        UPPExpr naddr = new UPPAdd(narray, sizeBytes);
        UPPExpr nval = val.toUPP(locals);
        return new UPPStore(naddr, nval);
    }//toUPP
...
class PPWhile extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        UPPExpr ncond = cond.toUPP(locals);
        UPPInst ninst = i.toUPP(locals);
        return new UPPWhile(ncond, ninst);
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () {
        ...
        for (Pair<String,Type> e : this.args) {
            nargs.add(e.left);
            nall.add(e.left);
        }
