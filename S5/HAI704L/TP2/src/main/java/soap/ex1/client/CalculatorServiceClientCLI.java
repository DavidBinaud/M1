package soap.ex1.client;

import soap.ex1.input.IntegerInputProcessor;
import soap.ex1.input.NonZeroIntegerInputProcessor;
import soap.ex1.ws.Calculator;
import soap.ex1.ws.CalculatorSoap;
    ...
    private void processUserInput(BufferedReader reader,
        ...
        try {
            switch(userInput) {
                ...
                case "3":
                    invokeServiceOperation(
                            new IntegerInputProcessor(reader),new IntegerInputProcessor(reader),
                            proxy,
                            "multiply");
                    break;
                case "4":
